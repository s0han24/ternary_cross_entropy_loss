...
class LoraArguments:
    ...
    use_int8: bool = field(default=False)  # Disable INT8 quantization
    use_gptq: bool = field(default=False)
...
def train():
    ...
    if lora_args.use_qlora:
        logger.info('** Use QLoRa quantization (4-bit).')
    ...
    elif lora_args.use_int8:
        logger.info('** Use INT8 quantization.')
        quantization_config = BitsAndBytesConfig(
                                load_in_8bit=True,
